...
def main(args):
    ...
    check_convergence(args.round_i,
                      centroids_fn='centroids-{how}-mk{version}-{round_i}.npy'.format(args),
                      tmat_fn='tmatfromclus-{how}-mk{version}-{round_i}.mtx'.format(args),
                      dir_path=os.getcwd())
...
def check_convergence(round_i, centroids_fn, tmat_fn, dir_path):
    ...
    result_obj.centroids_fn = centroids_fn
    result_obj.tmat_fn = tmat_fn
